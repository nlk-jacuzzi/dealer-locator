        ...
        <div style="margin:0px 8px 8px 5px;">
            <p style="color:#797979">
                ...
                <?php }elseif($seo_page_type == 'reviews'){?>
                    ...
                    <p style="color:#797979">
                        <?php echo $cityName;?> hot tub reviews give you a good place to start your spa search, but make plans to visit your <?php echo $html->link($cityName.' Jacuzzi Hot Tubs dealer', '/'.$stateInfo.'/'.str_replace(' ', '-', strtolower($cityName)).'-hot-tubs', array('class'=>'text-link'));?>. You'll see for yourself why Jacuzzi deserves high ratings.
