            ...
            <div class="dealer-two-col">
                ...
                <div class="dealer-lt-col">
                    <div class="dealer-images">
                        <div class="dealer-img-contain">
                            <?php foreach($dealer['Image'] as $i){
                                echo $this->Image->resize('/files/dealer_imgs/'.$i['dealer_id'].'/store/'.$i['path'], 304, 205, array('class' => 'dealerimg'));
                            }?>
                        </div>
                    ...
                    <div class="dealer-article" style="width:620px;">
                        ...
                        <?php if(!empty($dealer['Dealer']['show_service_area']) && !empty($this->viewVars['serviceArea'])): ?>
                            Service area: <?php echo implode(', ', $this->viewVars['serviceArea']) ?>
                        <?php else: ?>
                            <?php // Not showing service area ?>
                        <?php endif; ?>
                            ...
                            foreach($dealer['Staff'] as $s){?>
                                <p style="text-align: left; clear:left;">
                                    <?php if(!empty($s['photo'])){
                                        echo $this->Image->resize('/files/dealer_imgs/'.$s['dealer_id'].'/staff/'.$s['photo'], 100, 100, array('class' => 'dealerimg', 'align' => 'left', 'title' => $cityName.' Hot Tub Dealer', 'alt' => $s['name'].' '.$cityName.' Hot Tub Dealer'));
                                    }?>
                ...
                <div class="dealer-rt-col">
                    ...
                    <?php if($dealer['Dealer']['wet_test']){ ?>
                        <div class="dealer-wet-test widge wht">
                            <img src="<?php echo FULL_BASE_URL.dirname($this->base);?>/wp-content/themes/jht/images/dealer-locator/wet-test.jpg" />
                            <h3>Wet Test Here!</h3>
