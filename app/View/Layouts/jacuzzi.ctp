...
$wp_base = FULL_BASE_URL;
if ( $wp_base == 'http://www.nlkdevj.com' ) $wp_base .= '/hot-tubs';
$wp_base .= dirname($this->base);
if ( substr($wp_base, -1) !== '/' ) $wp_base .= '/';
...
<head>
  <!--dl--jacuzzi_ctp  -->
<meta charset="UTF-8" />
<title><?php echo (isset($layoutTitle)) ? $layoutTitle : 'Dealer Locator - Jacuzzi Hot Tubs' ?></title>
...
<link rel="stylesheet" type="text/css" media="all" href="<?php echo $wp_base;?>wp-content/themes/jht/style.css" />
<link rel='stylesheet' id='thickbox-css'  href='<?php echo $wp_base;?>wp-includes/js/thickbox/thickbox.css?ver=20121105' type='text/css' media='all' />
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js?ver=1.7.2"></script>
<script type="text/javascript" src="<?php echo $wp_base;?>wp-content/themes/jht/js/jquery.cookie.js?ver=1.0"></script>
...
<script type='text/javascript' src='<?php echo $wp_base;?>wp-includes/js/thickbox/thickbox.js?ver=3.1-20121105'></script>
<script type='text/javascript' src='<?php echo $wp_base;?>wp-content/themes/jht/js/frontend.js?ver=1.2.2'></script>
<!-- begin GA Code -->
<script type="text/javascript">
              ...
              <?php } else { ?>
                <div class="side">
                    ...
                    <div class="tub-brochure-pricing">
                        <div>
                            <a href="<?php echo $wp_base;?>request-brochure/" class="gold-button-208"><span class="the-content">Free Brochure<span>&gt;</span></span></a>
                        </div>
                        <div class="pages40">
                            <img src="<?php echo $wp_base;?>wp-content/themes/jht/images/callouts/40-pages-thumb.png" />
                        </div>
                    </div>
                    <!--div class="scall bro">
