...
if ( $wordpress_base == 'http://www.nlkdevj.com/' ) $wordpress_base .= 'hot-tubs/';
if ( substr($wordpress_base, -1) !== '/' ) $wordpress_base .= '/';
?>
...
<?php readfile($wordpress_base .'footer-dl'. ($this->action == 'index' ? 'landing' : 'results') .'/'); ?>
