...
#tpop { float: left; width: 536px; height: 224px; background: url(/hot-tubs/wp-content/themes/jht/images/bg/truckpop.jpg) no-repeat 0 0; padding: 17px 0 0 24px; font-family: "GSMT", Arial, Helvetica, sans-serif; color: #fff; position: relative }
...
#tpop a { float: left; width: 190px; font: bold 12px/18px Arial, Helvetica, sans-serif; padding: 196px 355px 0 15px; height: 45px; position: absolute; top: 0; left: 0; text-align: center; text-transform: uppercase; background: url(/hot-tubs/wp-content/themes/jht/images/icons/tbtn.png) no-repeat 15px 187px; color: #000; text-decoration: none; text-shadow: 1px 1px 1px #fff }
</style>
</head>
<body>
<?php } ?>
...
<h4>The Jacuzzi Truckload Sale<br />
